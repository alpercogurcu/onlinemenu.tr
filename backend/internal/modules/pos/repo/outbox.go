...
func InsertOutbox(ctx context.Context, tx pgx.Tx, aggregateType, aggregateID, eventType string, payload any) error {
	...
	_, err = tx.Exec(ctx, `
		INSERT INTO pos_outbox (event_id, aggregate_type, aggregate_id, event_type, payload)
		VALUES ($1, $2, $3, $4, $5)
	`, uuid.New(), aggregateType, aggregateID, eventType, string(data))
	if err != nil {
